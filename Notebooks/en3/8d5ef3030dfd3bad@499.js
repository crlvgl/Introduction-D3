...
<p style="background: #fffced; box-sizing: border-box; padding: 10px 20px; font-style: italic;">**Update May 2023:** This notebook has been deprecated and is no longer maintained; please see the newer [D3 histogram example](/@d3/histogram/2) and [Observable Plot histogram example](/@observablehq/plot-histogram).</p>
